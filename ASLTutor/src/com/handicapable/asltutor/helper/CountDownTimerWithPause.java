 ...
 * callback is complete. This is only relevant when the implementation of {@link #onTick(long)} takes an amount of time
...
public abstract class CountDownTimerWithPause {
	 ...
	 *            The interval in millis at which to execute {@link #onTick(millisUntilFinished)} callbacks
	 * @param runAtStart
